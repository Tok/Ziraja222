...
public class DoesItMeanServiceImpl extends RemoteServiceServlet implements DoesItMeanService {
    ...
    /**
     * Sends a query to google and returns the value of the "Did you mean"
     * function or ?? if there is no suggestion.
     */
    @Override
    public final String doesItMean(final String input) {
        String output = "??";
        try {
            ...
            output = "FAIL: URL malformed.";
        } catch (IOException e) {
            output = "FAIL: IO-Exception.";
        }
        return output;
    }
}
